...
export default function OtherTransaction({ data }) {
    const { user } = useAuth();
                        ...
                        >
                            ...
                            <View className="flex-row items-center justify-between w-full">
                                ...
                                <View className="items-end text-end">
                                    <Text className="font-bold text-base items-end" >{item.value.amount + " " + item.value.crypto_name}</Text>
                                </View>
                ...
                <View style={{ backgroundColor: "rgba(0,0,0,0.8)" }} className="flex-1 ">
                    ...
                    >
                        ...
                        <View style={{
                            ...
                            <View className="mb-4">
                                <Text>Amount</Text>
                                <Text className="font-extrabold text-lg">{showmodal.amount + " " + showmodal.crypto_name}</Text>
